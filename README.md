...
Note, this is not tested and is adjusted for use of dickieh/terraform-provider-zabbix

[![GoDoc](https://godoc.org/github.com/dickieh/go-zabbix-api?status.svg)](https://godoc.org/github.com/dickieh/go-zabbix-api) [![MIT License](https://img.shields.io/badge/license-MIT-blue.svg)](LICENSE)
...
Install it: `go get github.com/dickieh/go-zabbix-api`
...
Documentation is available on [godoc.org](https://godoc.org/github.com/dickieh/go-zabbix-api).
